...
function answerCouldNotExecuteError(filePath) {
...
function answerCouldNotLoadError(filePath) {
...
// Otherwise don't return anything.
  ...
  try {
    ...
    dynamicAnswer = answerCouldNotLoadError(filePath) + '\n' + JSON.stringify(new Error(error))
  ...
  if(typeof(dynamicAnswer) == 'function') {
    ...
    try {
      ...
      dynamicAnswer = answerCouldNotExecuteError(filePath) + '\n' + error
