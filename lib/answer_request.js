...
const noExports = Symbol('no_exports')
...
// Return true, if a valid dynamic answer was found and served.
// Otherwise don't return anything.
  ...
  try {
    ...
    console.debug('dynamicAnswer is', dynamicAnswer)

//const noExports = Symbol.for('no exports')



    if(noExports in dynamicAnswer) { console.debug('YES!') } // as suggested on SO, but does not work!
